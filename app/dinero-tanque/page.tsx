      ...
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400">
                Lleva el control del dinero que tenes para construir el tanque, lo que ya gastaste y cada compra nueva que vayas registrando.
              </p>
            </div>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <div className="rounded-3xl border border-emerald-500/30 bg-emerald-500/10 p-5">
            ...
            <p className="mt-2 text-sm text-emerald-200/80">Dinero restante despues de los gastos registrados.</p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-700 bg-slate-900/85 p-5">
            ...
            <p className="mt-2 text-sm text-slate-400">Suma total de compras y gastos cargados.</p>
          </div>
          ...
          <div className="rounded-3xl border border-slate-700 bg-slate-900/85 p-5">
            ...
            <p className="mt-2 text-sm text-slate-400">Cantidad de compras o gastos registrados hasta ahora.</p>
          </div>
        </div>
        ...
        <div className="mt-6 grid gap-6 xl:grid-cols-[1.05fr_1.45fr]">
          <div className="space-y-6">
            <section className="rounded-3xl border border-slate-700 bg-slate-900/85 p-6 shadow-2xl shadow-black/10">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-400">
                    Define con cuanto dinero contas para este proyecto.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  ...
                  className="rounded-2xl bg-emerald-500 px-5 py-3 font-semibold text-slate-950 disabled:opacity-60"
                >
            ...
            <section className="rounded-3xl border border-slate-700 bg-slate-900/85 p-6 shadow-2xl shadow-black/10">
              ...
              <p className="mt-2 text-sm text-slate-400">
                Registra cada salida de dinero para mantener el saldo siempre al dia.
              </p>
              ...
              <form onSubmit={addExpense} className="mt-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Opcional: detalle de la compra, lugar, observaciones"
                  />
                </div>
          ...
          <section className="rounded-3xl border border-slate-700 bg-slate-900/85 p-6 shadow-2xl shadow-black/10">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-400">
                  Lista de todo lo que ya compraste o gastaste para el tanque.
                </p>
              </div>
