...
export function SharedCaseForm({ cards, saving, onSave, onCancel }: Props) {
  ...
  async function submit(event: FormEvent) {
    ...
    const success = await onSave({ title, notes, participantNames: names, participantAmounts, purchase: { description: purchase.description, purchaseDate: purchase.purchaseDate, amount: total, cardId: purchase.cardId || null, firstOpportunity: purchase.firstInstallmentDate, secondOpportunity: secondDate, installmentCount: purchase.installmentCount, firstInstallmentDate: purchase.firstInstallmentDate } });
    if (success) onCancel();
  }
